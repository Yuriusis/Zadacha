...
<head>
	...
	<title>Будущая професия</title>
	<style>
  body { background: url(img/7.jpg); }
</style>
</head>
<body>
	<?php require "blocks/header.php" ?>
		<div class="col-md-3 container bg-dark" style="margin-top: 65px; margin-left: 100px;" align="center">
      <div class="row no-gutters">
        <div class="p-4">
          <strong class="d-inline-block mb-2" style="color:#8B4513"><h1>Компьютерный инженер</h1></strong>
          <p class="" style="color:#FFFFF0">
